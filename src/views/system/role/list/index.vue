	...
	<div class="table-box">
		<ProTable ref="proTableRef" v-bind="proTableAttrs">
			...
			<template #tableHeader="scope">
				<el-button v-auth="`button-create`" type="primary" icon="CirclePlus" tag="router-link" to="/system/role/create">
					新增
				</el-button>
				<el-button
			...
			<template #operation="{ row }">
				...
				<el-button
					...
					:to="`/system/role/update?id=${row.id}`"
					tag="router-link"
					type="primary"
					link
					icon="EditPen"
...
<script setup lang="ts" name="system-role-list">
