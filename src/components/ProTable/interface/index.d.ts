...
import type { BreakPoint, Responsive } from "@/components/AGrid/interface";
import type { TableProps } from "element-plus";
import type { TableColumnCtx } from "element-plus/es/components/table/src/table-column/defaults";
import type { ProTableProps as ProtableIndexProps } from "@/components/ProTable/index.vue";
...
export type ProTableProps = ProtableIndexProps & Omit<TableProps<any>, "data" | "columns" | "border" | "rowKey" | "">;
export type ProTableInstance = Omit<
	InstanceType<typeof ProTable>,
	keyof ComponentPublicInstance | keyof ProtableIndexProps
>;
